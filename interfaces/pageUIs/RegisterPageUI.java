...
public class RegisterPageUI {
    public static final String NOPCOMMERCE_LOGO = "//div[@class='header-logo']/a";
    ...
    public static final String EMAIL_EXITING_ERROR_MSG = "//div[contains(@class,'message-error')]//li";
    public static final String PASSWORD_ERROR_MSG = "//span[contains(@class,'field-validation-error')]";
